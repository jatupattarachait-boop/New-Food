...
export const highFidelityRecipes = [
  ...
  },
  {
    ...
    ingredients: [
      { id: "i-shrimp-2", name: "กุ้งสดลายเสือ", amount: 150, unit: "g", caloriesPerGram: 1.2, protein: 0.24, carbs: 0.01, fat: 0.02 },
    ...
    alternativeIngredients: {
      "i-shrimp-2": ["เนื้อไก่หั่นเต๋า", "เนื้อปลากะพง", "เห็ดนางฟ้าเพิ่มเติม (สำหรับมังสวิรัติ)"],
