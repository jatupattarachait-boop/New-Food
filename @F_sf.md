...
*   **ความเรียบง่ายแต่หรูหราและโปร่งใส (Gold & White Glassmorphism UI):**
    ...
    *   **Fine Gold Lines & Elegant Shadows:** ใช้เส้นขอบทองคำบางพิเศษ (Fine Hairline Borders) และเงาฟุ้งแบบนุ่มละมุนโทนสีทองบางเบา หลีกเลี่ยงแสงเรืองรองที่เข้มเกินไป
    *   **Elegant Typography:** ใช้ฟอนต์ไม่มีหัวสไตล์พรีเมียม (เช่น *Outfit*, *Inter* หรือ *Sarabun*) ที่จัดระยะห่างอย่างสะอาดตาและผ่อนคลาย
*   **โทนสีทองและขาวสุดหรูหรา (Luxurious Gold & White Colors):**
    *   **Light Mode (หรูหรา สะอาดตา และอบอุ่น):**
        *   **สีพื้นหลังหลัก:** สีขาวไข่มุกและขาวลินินอุ่นสุดพรีเมียม (`#FAF9F6` / `#FFFFFF`)
    ...
    *   **Dark Mode (ลุ่มลึก สง่างาม และพรีเมียมเข้ม):**
        *   **สีพื้นหลังหลัก:** สีดำชาร์โคลมืดลึกพิเศษ (`#121415`) และสีดำเทาสงบนิ่ง (`#1A1C1E`)
